...
@php
    ...
    $singlePageTitle = 'Payment Type';
    $routePrefix = 'paymentTypes';
    $pageUrl = 'payment-types';
@endphp
        ...
        $(document).ready(function (){
            ...
            $('.save-this-form').on('click', function (){
                ...
                if($name != ''){
                    ...
                    $('#form-alert-area').html('');
                    $alert = alertDanger('Payment Type can not be empty!', 'Error');
                    $('#form-alert-area').html($alert);
                    $($this).prop('disabled', false);
                }
            ...
            $('.table').on('click', '.edit', function (){
                ...
                $.ajax({
                    ...
                    success: function ($res, $textStatus, $jqXHR) {
                        $('#edit-id').val($res.id);
                        $('#name-input').val($res.payment_type);
                        $('#form-alert-area').html('');
