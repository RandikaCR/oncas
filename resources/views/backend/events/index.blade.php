    ...
    @section('header_buttons')
        <div class="row">
            <div class="col-sm-12 d-flex justify-content-end mb-3">
                <a href="{{ route('backend.events.create') }}" class="btn btn-primary me-3">
                                    ...
                                    <div class="table-responsive mt-4 mt-xl-0">
                                        <table class="table table-hover table-striped align-middle table-nowrap mb-0">
                                            ...
                                            @foreach($records as $row)
                                                <tr id="row-{{ $row->id }}">
                                                    <td>
                                                        <p class="mb-0 fw-medium">{{ $row->event }}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p class="mb-0">{{ $row->venue }}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p class="mb-0">{{ dateTimeFullFormat($row->start_time) }}</p>
                                                    ...
                                                    <td class="text-end">
                                                        <div class="d-flex justify-content-end align-items-center">
                                                            ...
                                                            <div>
                                                                <a href="{{ route('backend.events.view', $row->id) }}" class="btn btn-primary btn-sm waves-effect waves-light" data-bs-toggle="tooltip" data-bs-placement="top" title="View"><span class="mdi mdi-magnify"></span></a>
                                                                <a href="{{ route('backend.events.edit', $row->id) }}" class="btn btn-primary btn-sm waves-effect waves-light" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><span class="mdi mdi-pencil"></span></a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
