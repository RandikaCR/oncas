                                        ...
                                        <table class="table table-hover table-striped align-middle table-nowrap mb-0">
                                            ...
                                            @foreach($records as $row)
                                                <tr id="row-{{ $row->id }}">
                                                    ...
                                                    <td>
                                                        <p class="mb-0">{{ $row->display_name }}</p>
                                                    </td>
        ...
        $(document).ready(function (){
            ...
            $('.save-this-form').on('click', function (){
                ...
                if($name != '' && $displayName != ''){
                    ...
                    $('#form-alert-area').html('');
                    $alert = alertDanger('User Role & Display Name can not be empty!', 'Error');
                    $('#form-alert-area').html($alert);
                    $($this).prop('disabled', false);
                }
            ...
            $('.table').on('click', '.edit', function (){
                ...
                $.ajax({
                    ...
                    success: function ($res, $textStatus, $jqXHR) {
                        $('#edit-id').val($res.id);
                        $('#name-input').val($res.user_role);
                        $('#second-input').val($res.display_name);
                        $('#form-alert-area').html('');
