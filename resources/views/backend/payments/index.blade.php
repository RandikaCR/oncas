    ...
    @section('header_buttons')
        <div class="row">
            <div class="col-sm-12 d-flex justify-content-end mb-3">
                <a href="{{ route('backend.payments.create') }}" class="btn btn-primary me-3">
                                            ...
                                            @foreach($payments as $row)
                                                <tr id="row-{{ $row->id }}">
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <p class="mb-0 text-muted">{{ dateTimeFullFormat($row->created_at) }}</p>
                                                    </td>
                                                    <td class="text-end">
                                                        <div class="d-flex justify-content-end align-items-center">
                                                            <div>
                                                                <a href="{{ route('backend.payments.view', $row->id) }}" class="btn btn-primary btn-sm waves-effect waves-light" data-bs-toggle="tooltip" data-bs-placement="top" title="View"><span class="mdi mdi-magnify"></span></a>
                                                                <a href="{{ route('backend.payments.edit', $row->id) }}" class="btn btn-primary btn-sm waves-effect waves-light" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><span class="mdi mdi-pencil"></span></a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
