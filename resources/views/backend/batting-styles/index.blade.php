...
@php
    $pageTitle = 'Batting Styles';
    $singlePageTitle = 'Batting Style';
    $routePrefix = 'battingStyles';
    $pageUrl = 'batting-styles';
@endphp
        ...
        $(document).ready(function (){
            $('.save-this-form').on('click', function (){
                ...
                if($name != ''){
                    ...
                    $('#form-alert-area').html('');
                    $alert = alertDanger('Batting Style can not be empty!', 'Error');
                    $('#form-alert-area').html($alert);
                    $($this).prop('disabled', false);
                }
            ...
            $('.table').on('click', '.edit', function (){
                ...
                $.ajax({
                    ...
                    success: function ($res, $textStatus, $jqXHR) {
                        $('#edit-id').val($res.id);
                        $('#name-input').val($res.batting_style);
                        $('#form-alert-area').html('');
